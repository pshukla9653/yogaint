...
<div class="right-sidebar">
    <h1 class="text-center"><i class="fa fa-columns"></i> Category</h1>
    <button data-id="0" class="btn-2 pull-right cl_add_cat_pop">Add New Category</button>
    <div class="tablelist-card">
    	<?php echo $obj->category_list(); ?>
    </div>
    <div class="overlap">
